...
pub fn new_full_base(
	...
	// if the substrate isn't actively participating in consensus then it doesn't
...
mod tests {
	...
	#[test]
	// It is "ignored", but the substrate-cli ignored tests are running on the CI.
	// This can be run locally with `cargo test --release -p substrate-cli test_sync -- --ignored`.
	#[ignore]
	fn test_sync() {
