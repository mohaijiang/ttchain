...
//! ```text
//! wasm-pack test --firefox --release --headless bin/substrate/browser-testing
//! ```
...
async fn runs() {
	...
	// Check that the substrate handles rpc calls.
	// TODO: Re-add the code that checks if the substrate is syncing.
