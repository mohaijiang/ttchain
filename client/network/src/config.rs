...
pub struct Params<B: BlockT, H: ExHashT> {
	/// Assigned role for our substrate (full, light, ...).
	pub role: Role,
...
/// Role of the local substrate.
#[derive(Debug, Clone)]
pub enum Role {
	/// Regular full substrate.
	Full,
	/// Regular light substrate.
	Light,
	/// Actual authority.
	Authority,
}
...
/// Address of a substrate, including its identity.
///
...
pub struct NetworkConfiguration {
	...
	/// List of initial substrate addresses
	pub boot_nodes: Vec<MultiaddrWithPeerId>,
	/// The substrate key configuration, which determines the substrate's network identity keypair.
	pub node_key: NodeKeyConfig,
	/// List of request-response protocols that the substrate supports.
	...
	/// Name of the substrate. Sent over the wire for debugging purposes.
	...
	///
	/// If true, the substrate will automatically randomly walk the DHT in order to find new peers.
...
pub struct SetConfig {
	...
	pub out_peers: u32,
	/// List of reserved substrate addresses.
...
impl NonDefaultSetConfig {
	...
	/// Add a substrate to the list of reserved nodes.
...
/// The configuration of a substrate's secret key, describing the type of key
/// and how it is obtained. A substrate's identity keypair is the result of
/// the evaluation of the substrate key configuration.
#[derive(Clone, Debug)]
