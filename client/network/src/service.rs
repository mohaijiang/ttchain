...
pub struct NetworkService<B: BlockT + 'static, H: ExHashT> {
	...
	/// Local copy of the `PeerId` of the local substrate.
...
impl<B: BlockT + 'static, H: ExHashT> NetworkWorker<B, H> {
	...
	/// Adds an address for a substrate.
	...
	/// and peer ID of the remote substrate.
...
impl<B: BlockT + 'static, H: ExHashT> NetworkService<B, H> {
	...
	/// Adds an address known to a substrate.
	...
	/// Disconnect from a substrate as soon as possible.
	///
	/// This triggers the same effects as if the connection had closed itself spontaneously.
	///
	/// See also [`NetworkService::remove_from_peers_set`], which has the same effect but also
	/// prevents the local substrate from re-establishing an outgoing substream to this peer until it
	/// is added again.
