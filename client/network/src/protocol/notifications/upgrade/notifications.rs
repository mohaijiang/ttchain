...
///
/// - Node A opens a substream to substrate B and sends a message which contains some protocol-specific
...
/// - If substrate B accepts the substream, it sends back a message with the same properties.
...
/// - Either substrate A or substrate B can signal that it doesn't want this notifications substream anymore
