...
/// 2020-10-16 08:03:14  ⛓  Native runtime: substrate-template-1 (substrate-template-1.tx1.au1)
...
/// 2020-10-16 08:03:15  [light] 🏷 Local substrate identity is: 12D3KooWHX4rkWT6a6N55Km7ZnvenGdShSKPkzJ3yj9DU5nqDtWR
...
/// ```
///
/// # Example using the actual substrate name
///
/// ```ignore
/// Builds a new service for a light client.
...
/// 2020-10-16 08:12:57  ⛓  Native runtime: substrate-template-1 (substrate-template-1.tx1.au1)
...
/// 2020-10-16 08:12:58  [open-harbor-1619] 🏷 Local substrate identity is: 12D3KooWRzmYC8QTK1Pm8Cfvid3skTS4Hn54jc4AUtje8Rqbfgtp
...
pub fn prefix_logs_with(arg: TokenStream, item: TokenStream) -> TokenStream {
	...
	if arg.is_empty() {
		return Error::new(
			Span::call_site(),
			"missing argument: name of the substrate. Example: sc_cli::prefix_logs_with(<expr>)",
		)
		.to_compile_error()
		.into();
	}
