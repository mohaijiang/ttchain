...
/// Create the initial parts of a full substrate.
...
/// Create the initial parts of a light substrate.
...
pub struct SpawnTasksParams<'a, TBl: BlockT, TCl, TExPool, TRpc, Backend> {
	...
	/// Telemetry instance for this substrate.
...
/// Spawn the tasks that are required to run a substrate.
		...
		TImpQu: ImportQueue<TBl> + 'static,
{
	...
	let network_params = sc_network::config::Params {
		...
		executor: {
			...
			Some(Box::new(move |fut| {
				spawn_handle.spawn("libp2p-substrate", fut);
			}))
		},
	...
	// substrate through the `NetworkConfiguration` struct. But because this function doesn't know in
