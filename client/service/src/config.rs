...
pub struct Configuration {
	...
	///
	/// Should only be set when `substrate` is running development mode.
...
impl Configuration {
	/// Returns a string displaying the substrate role.
...
/// The base path that is used for everything that needs to be write on disk to run a substrate.
#[derive(Debug)]
pub enum BasePath {
