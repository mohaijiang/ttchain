...
//! overlay allows to get any trie substrate that was inserted in any of the blocks within the window.
...
/// Basic set of requirements for the Block hash and substrate key types.
...
/// A set of state substrate changes.
