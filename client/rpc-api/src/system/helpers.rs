...
/// Running substrate's static details.
#[derive(Clone, Debug)]
...
pub struct Health {
	...
	pub peers: usize,
	/// Is the substrate syncing
	pub is_syncing: bool,
	/// Should this substrate have any peers
	///
...
/// The role the substrate is running as
#[derive(Debug, PartialEq, Serialize, Deserialize)]
pub enum NodeRole {
	/// The substrate is a full substrate
	Full,
	/// The substrate is a light client
	LightClient,
	/// The substrate is an authority
	Authority,
}

/// The state of the syncing of the substrate.
#[derive(Debug, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SyncState<Number> {
	/// Height of the block at which syncing started.
	pub starting_block: Number,
	/// Height of the current best block of the substrate.
