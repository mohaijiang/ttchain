...
pub trait StateApi<Hash> {
	...
	/// ## Node requirements
	///
	/// - Fully synced archive substrate (i.e. a substrate that is not actively doing a "major" sync).
	...
	/// - Run substrate flags to increase DB read speed (i.e. `--state-cache-size`, `--db-cache`).
	///
	...
	/// - Run the substrate with the wasm blob overrides by placing them in a folder with all your runtimes,
