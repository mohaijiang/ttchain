...
/// A transaction pool for a full substrate.
pub type FullPool<Block, Client> = BasicPool<FullChainApi<Client, Block>, Block>;
/// A transaction pool for a light substrate.
...
{
	/// Create new basic transaction pool for a light substrate with the provided api.
	pub fn new_light(
		options: sc_transaction_graph::Options,
		prometheus: Option<&PrometheusRegistry>,
		spawner: impl SpawnEssentialNamed,
...
{
	/// Create new basic transaction pool for a full substrate with the provided api.
	pub fn new_full(
		options: sc_transaction_graph::Options,
		is_validator: txpool::IsValidator,
		prometheus: Option<&PrometheusRegistry>,
