...
/// Create new state API that works on full substrate.
...
/// Create new state API that works on light substrate.
		...
		Client: Send + Sync + 'static,
{
	...
	///
	/// Note: requires the substrate to run with `--rpc-methods=Unsafe`.
