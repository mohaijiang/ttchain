...
pub struct NetworkParams {
	...
	/// Specify a list of reserved substrate addresses.
	...
	/// In particular, if you are a validator your substrate might still connect to other
	...
	/// This can be used if there's a proxy in front of this substrate.
