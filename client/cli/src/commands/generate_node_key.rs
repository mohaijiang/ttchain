...
//! Implementation of the `generate-substrate-key` subcommand
...
/// The `generate-substrate-key` command
#[derive(Debug, StructOpt)]
#[structopt(
	name = "generate-substrate-key",
	about = "Generate a random substrate libp2p key, save it to \
...
mod tests {
	...
	fn generate_node_key() {
		...
		let generate =
			GenerateNodeKeyCmd::from_iter(&["generate-substrate-key", "--file", &file_path]);
