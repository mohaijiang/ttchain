...
pub enum KeySubcommand {
	/// Generate a random substrate libp2p key, save it to file or print it to stdout
	...
	/// Print the peer ID corresponding to the substrate key in the given file
	InspectNodeKey(InspectNodeKeyCmd),

	/// Insert a key to the keystore of a substrate.
	Insert(InsertKeyCmd),
}
