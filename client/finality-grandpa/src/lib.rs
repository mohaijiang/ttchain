...
pub struct Config {
	...
	/// a full-substrate not running as a validator is running the GRANDPA observer
	/// protocol (we will only issue catch-up requests to authorities when the
	/// observer protocol is enabled).
	pub observer_enabled: bool,
	/// The role of the local substrate (i.e. authority, full-substrate or light).
	pub local_role: sc_network::config::Role,
	/// Some local identifier of the voter.
	pub name: Option<String>,
	/// The keystore that manages the keys of this substrate.
...
/// Checks if this substrate has any available keys in the keystore for any authority id in the given
