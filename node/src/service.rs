...
>, ServiceError> {
	...
	let (rpc_extensions_builder, rpc_setup) = {
		...
		let rpc_extensions_builder = move |deny_unsafe, subscription_executor| {
			let deps = self::super::rpc::FullDeps {
				...
				deny_unsafe,
				babe: self::super::rpc::BabeDeps {
					babe_config: babe_config.clone(),
					shared_epoch_changes: shared_epoch_changes.clone(),
					keystore: keystore.clone(),
				},
				grandpa: self::super::rpc::GrandpaDeps {
			...
			self::super::rpc::create_full(deps)
		};
...
pub fn new_full_base(
	...
	// if the newtouch isn't actively participating in consensus then it doesn't
...
pub fn new_light_base(
	...
	let light_deps = super::rpc::LightDeps {
	...
	let rpc_extensions = super::rpc::create_light(light_deps);
