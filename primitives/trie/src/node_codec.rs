...
/// Helper struct for trie substrate decoder. This implements `codec::Input` on a byte slice, while
...
/// Encode and allocate substrate type header (type and size), and partial value.
