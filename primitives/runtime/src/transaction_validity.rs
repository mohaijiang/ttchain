...
/// by our local substrate (for instance off-chain workers).
...
pub enum TransactionSource {
	...
	///
	/// This means that the transaction was produced internally by the substrate
...
pub struct ValidTransaction {
	...
	/// including in blocks that are authored on the current substrate, but will
