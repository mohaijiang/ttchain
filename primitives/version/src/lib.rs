...
pub struct RuntimeVersion {
	/// Identifies the different Substrate runtimes. There'll be at least polkadot and substrate.
	/// A different on-chain spec_name to that of the native runtime would normally result
	/// in substrate not attempting to sync or author blocks.
	pub spec_name: RuntimeString,

	/// Name of the implementation of the spec. This is of little consequence for the substrate
	...
	/// `authoring_version` is the version of the authorship interface. An authoring substrate
	/// will not attempt to author blocks unless this is equal to its native runtime.
	pub authoring_version: u32,

	/// Version of the runtime specification. A full-substrate will not attempt to use its native
